...
| `05-runtime.md` | Grant engine lifecycle, collect-all mechanics, modes, outbox (C6, R3/R4) | DRAFT v0.1 |
| `06-observability.md` | CLI replay, exports, invariant runner, page triggers (C10/C11) | DRAFT v0.1 |
